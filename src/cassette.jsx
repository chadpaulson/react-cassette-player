...
var Cassette = React.createClass({
  ...
  render: function() {
    ...
    if(this.state.rt >= 0.07) {
      ...
      var rightSpool = <path fill={this.props.tapeColor} d={rs} transform="translate(100, 0) scale(-1, 1)" />
    } else {
      var rightSpool = null
    }
    if(this.state.playing) {
      var playControls = (
        <g transform="scale(0.14) translate(285,465)">
          <rect fill={this.props.controlsColor} x="50.927" y="28.349" width="10.715" height="42.863"/>
          <rect fill={this.props.controlsColor} x="72.359" y="28.349" width="10.718" height="42.863"/>
        </g>        
      )      
      ...
      var playControls = (
        <g transform="scale(0.14) translate(325,465)">
          <path fill={this.props.controlsColor} d="M16.785,27.729c-1.745-0.816-3.862-1.089-3.862,1.617v40.985c0,2.498,1.909,2.844,3.874,1.685l27.77-19.994   c2.093-1.537,1.419-3.089-0.179-4.405L16.785,27.729z"/>
        </g>        
      )
    }
    return (
