...
var Cassette = React.createClass({
  ...
  render: function () {
    ...
    if (this.state.playing) {
      var playControls = React.createElement(
        'g',
        { transform: 'scale(0.14) translate(285,465)' },
      ...
      var playControls = React.createElement(
        'g',
        { transform: 'scale(0.14) translate(325,465)' },
    ...
    return React.createElement(
      ...
      React.createElement(
        'audio',
        { ref: 'player', preload: this.props.preload },
        React.createElement('source', { src: this.props.src, type: this.props.mimeType })
      ),
      React.createElement(
        'svg',
        { onClick: this.togglePlayPause, x: '0px', y: '0px', width: '100%', height: '100%', viewBox: '0 0 100 100', preserveAspectRatio: scaleMethod },
        React.createElement(
          'g',
          null,
